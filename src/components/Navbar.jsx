...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="bg-white border-gray-200 fixed w-full z-50 mobileonly">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 w-full bbpx">
    ...
    <div className={`${isNavbarOpen ? 'block' : 'hidden'} w-full md:block md:w-auto`} id="navbar-dropdown">
      <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 md:flex-row md:mt-0 md:border-0 md:bg-white">
        <li>
          <Link to="/candidates" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">
            For Candidates
          </Link>
        </li>
        <li>
          <Link to="/organisation" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">
            For Organisations
          </Link>
        </li>
        <li className="relative">
          ...
          {toggleAboutMenu && (
            <div className="absolute top-full left-0 bg-white shadow-md rounded-lg mt-1 z-10 w-44">
              ...
              <Link to="/career" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                Careers
              </Link>
        ...
        <li>
          <Link to="/training" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">
            Training
          </Link>
        </li>
        <li>
          <Link to="/pricing" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">
            Pricing
          </Link>
        </li>
        <li>
          <Link to="/news" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">
            News & Insights
          </Link>
        </li>
        <li>
